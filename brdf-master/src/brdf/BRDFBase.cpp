...
{      
    ...
    if( extension == "binary" )
    {
        ...
        b = mb;
      //  b-> numBRDFSamples=mb->numBRDFSamples;
      //  b->p=mb->p;
      //   float* brdfData= new float[90*90*180*3];
       //    unsigned int numBytes = mb->numBRDFSamples * 3 * sizeof(float);
  //   memcpy( mb->p, brdfData, numBytes );
  //      std::cout<<"numbbb"<<b->numBRDFSamples<<std::endl;
 //      std::cout<<mb->tbo;
  //       b->tex=mb->tex;
    }
